    ...
    <style>
      * {
      ...
      .site-header {
        ...
        top: 0;
        z-index: 1000;
        padding: 1rem 2rem 0.5rem; /* real breathing space */
      }
      ...
      .dropdown-menu {
        ...
        position: absolute;
        top: 100%;
        left: 0; /* anchor under its parent */
        background: white;
        min-width: 220px;
        width: max-content;
        padding: 15px;
      ...
      .dropdown-menu li {
        padding: 2px 0;
        width: 100%; /* ENSURE ITEMS STAY INSIDE */
        list-style: none;
      }
      ...
      @media screen and (max-width: 900px) {
        .site-header {
          padding: 0.8rem 1rem 0.5rem; /* real breathing space */
        }
        ...
        .bounce-text {
          animation: marquee 12s linear infinite; /* optional: faster on mobile */
        }
  ...
  <body>
    ...
    <div class="card">
      <div class="card-1">
        ...
        <a href="#" class="card-btn"
          >LEARN MORE &nbsp; <span>&RightArrow;</span></a
        >
      </div>
    ...
    <div class="unique">
      ...
      <div class="learn">
        ...
        <a href=""><h2>DISCOVER MORE ABOUT US</h2></a>
      </div>
    </div>
